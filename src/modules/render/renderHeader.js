...
export const searchButton = createElement('button', {
  ...
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M16.4431 16.4438L20.9994 21.0002" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
  `,
}, {
  cb(btn) {
...
export const cartLink = createElement('a', {
  ...
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M8.25 6.75C8.25 5.75544 8.64509 4.80161 9.34835 4.09835C10.0516 3.39509 11.0054 3 12 3C12.9946 3 13.9484 3.39509 14.6517 4.09835C15.3549 4.80161 15.75 5.75544 15.75 6.75" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
  `,
  href: 'cart',
});
...
const container = createElement('div', {
  ...
  innerHTML: `
    <a href="tel:89304902620" class="header__phone header__link"
      >8 930 490 26 20</a
    >
  `,
});
